...
Object.entries(shoulderCase.encounters.eval.objective.regionalAssessments.rom).forEach(
  ([key, value]) => {},
);

Object.entries(shoulderCase.encounters.eval.objective.regionalAssessments.mmt).forEach(
  ([key, value]) => {},
);
