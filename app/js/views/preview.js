...
route('#/preview', async (app, qs) => {
  ...
  try {
    ...
    app.innerHTML = '';
    app.append(el('div', {class: 'panel error'}, 'Error loading case. Please check the console for details.'));
    return;
  }
  ...
  const p = el('div', { class: 'panel' }, [
    ...
    el('div', { class: 'small' }, `Setting: ${c.meta.setting} • Regions: ${c.meta.regions?.join(', ') || '—'}`),
    el('div', { class: 'hr' }),
    el('h3', {}, 'Snapshot'),
